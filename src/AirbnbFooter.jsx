  ...
  return (
    <footer class="px-40 py-16 flex flex-col items-start gap-12 w-full bg-gray-50">
      ...
      <div className="border-t pt-4 flex flex-col md:flex-row justify-between items-center text-sm text-gray-600">
        <div>
          © 2024 Airbnb, Inc. · <a href="#" className="underline">Privacy</a> · <a href="#" className="underline">Terms</a> · <a href="#" className="underline">Sitemap</a>
        </div>
        <div className="flex items-center space-x-6 mt-4 md:mt-0">
          ...
          <div className="flex space-x-4">
            <a href="#" aria-label="Facebook" className="hover:underline">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="text-gray-600">
